 ...
 * GET /api/account? account_book=1
type
    1 支付宝
    2 微信
    ...
...
/**
 * 流水分类
 * GET /api/category?turnover_type=1
turnover_type
    1 收入
    2 支出
------------------
id    name    icon_name      color    turnover_type
1     工资     icon-gongzi    #FFFFFF  1
2     奖金     icon-gongzi    #FFFFFF  1
3     兼职     icon-gongzi    #FFFFFF  1
4     餐饮     icon-gongzi    #FFFFFF  2
5     娱乐     icon-gongzi    #FFFFFF  2
6     购物     icon-gongzi    #FFFFFF  2
------------------*/
...
/* 获取账户下的流水
 * GET /api/turnover/by/account?type=1(支付宝)
-----------------------------
    day   name    date      price    note      icon   turnover_type    account
    6     餐饮     1004...   1000.00  这是备注    1      2                1
    11    餐饮     1004...   1000.00  这是备注    1      2                1
    12    餐饮     1004...   1000.00  这是备注    1      2                1
    106   餐饮     1004...   1000.00  这是备注    1      2                1
    204   餐饮     1004...   1000.00  这是备注    1      2                1
    205   餐饮     1004...   1000.00  这是备注    1      2                1
---------------------------*/
